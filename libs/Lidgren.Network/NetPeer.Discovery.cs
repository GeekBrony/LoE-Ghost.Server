...
namespace Lidgren.Network
{
	public partial class NetPeer
	{
		...
		public void DiscoverLocalPeers(int serverPort)
		{
			...
			m_unsentUnconnectedMessages.Enqueue(new Tuple<NetEndPoint, NetOutgoingMessage>(new NetEndPoint(NetUtility.GetBroadcastAddress(), serverPort), um));
		}
		...
		public void DiscoverKnownPeer(NetEndPoint endPoint)
		{
			...
			m_unsentUnconnectedMessages.Enqueue(new Tuple<NetEndPoint, NetOutgoingMessage>(endPoint, om));
		}
		...
		public void SendDiscoveryResponse(NetOutgoingMessage msg, NetEndPoint recipient)
		{
			...
			m_unsentUnconnectedMessages.Enqueue(new Tuple<NetEndPoint, NetOutgoingMessage>(recipient, msg));
		}
	}
}
